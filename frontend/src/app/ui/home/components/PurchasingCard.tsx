	...
	return (
		<article className='small-intersection-animation opacity-0 slide-up-animation flex flex-col items-center gap-8 flex-grow-[1] w-full h-full'>
			<div
				...
				{plan === PlanEnum.free && <p className='text-xl'>Free plan</p>}
				{plan === PlanEnum.standard && <p className='text-xl'>Standard plan</p>}
				{plan === PlanEnum.pro && <p className='text-xl'>Pro plan</p>}
				<div className='flex items-center gap-3'>
					{plan === PlanEnum.free && <p className='text-xl'>$0</p>}
			...
			<ul className='flex flex-col w-full gap-3'>
				<li className='flex items-center gap-2'>
					...
					{plan === PlanEnum.free && <p className='text-sm'>Limited generate images (100 credits / month)</p>}
				...
				<li className='flex items-center gap-2'>
					<span className='w-2 h-2 bg-zinc-400 rounded-full' />
					{plan === PlanEnum.free && <p className='text-sm'>Basic prompt tags</p>}
